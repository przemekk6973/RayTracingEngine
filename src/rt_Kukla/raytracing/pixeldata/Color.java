...
public class Color {
    ...
    //zwraca nowy kolor, który jest wynikiem mnożenia wartości kolorów bieżącego obiektu przez wartości koloru innego obiektu
    public Color multiply(Color other) {
        return new Color(red*other.red, green*other.green, blue*other.blue);
    }

    //zwraca nowy kolor, który jest wynikiem pomnożenia wartości kolorów bieżącego obiektu przez wartość jasności
    public Color multiply(float brightness) {
        brightness = Math.min(1, brightness);
        return new Color(red * brightness, green * brightness, blue * brightness);
    }

    //zwraca nowy kolor, który jest wynikiem dodania wartości koloru bieżącego obiektu do wartości koloru innego obiektu
    public Color add(Color other) {
        return new Color(Math.min(1, this.red+other.red), Math.min(1, this.green+other.green), Math.min(1, this.blue+other.blue));
    }

    //dodaje wartości kolorów innego obiektu do wartości kolorów bieżącego obiektu
    ...
    //zwraca nowy kolor, który jest wynikiem dodania wartości koloru bieżącego obiektu do wartości jasności przekazanej jako parametr
    ...
    // zwraca wartość koloru w formacie RGB
    public int getRGB() {
    ...
    //zwraca wartość jasności koloru
