...
public class AnimationRenderer {
    ...
    //rendering klatek na podstawie wejsciowej i wyjsciowej pozycji kamery, liczenie klatek posrednich
    
    public static void renderImageSequence(Scene scene, File outputDirectory, int outputWidth, int outputHeight, int frameCount, float resolution) throws IOException {
        for (int frame = 0; frame<frameCount; frame++) {
            ...
            Renderer.renderScene(scene, frameBuffer.getGraphics(), outputWidth, outputHeight, resolution);
